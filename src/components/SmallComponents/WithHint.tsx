            ...
            <AnimatePresence initial={false}>
                {isHover && (
                    <motion.h1
                        ...
                        className={`${
                            directionObj.margin
                        } pointer-events-none absolute z-absolute h-fit w-fit select-none whitespace-nowrap rounded-lg px-3 py-1 font-semibold text-zinc-400 shadow-lg dark:bg-darker-bg ${
